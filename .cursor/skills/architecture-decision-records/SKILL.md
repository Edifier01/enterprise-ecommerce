...
---
> **Project:** Enterprise E-Commerce Platform | **Tier:** Architecture & Quality | **Manifest:** `docs/SKILL-MANIFEST.md`
...
3. Record the decision, rationale, and consequences in `docs/adr/ADR-NNN-title.md` (use `templates/09-adr-template.md`).
4. Link related ADRs and update status over time.
5. **Sync to project state:** add index entry in `.cursor/project-management/DECISIONS.md` (Decision ID, date, status, link to full ADR, brief context — do not duplicate full ADR text).
6. **Optional:** store convention summary in Memory MCP per `docs/MEMORY.md`.
